...
## App Description
A reactive, real-time todo application where users can create, manage, and complete todos. Completed todos are checked off and hidden from the main view, keeping the list focused on active work.
